...
function init() {
  ...
  if(firstRun()) {
    ...
    console.log(chalk.blue("Welcome to Liri, because siri just isn't good enough."));
  ...
  inquirer.prompt([
    {
      ...
      "type": 'list',
      "choices": ['Spotify a Song', 'Fetch Movie Info', 'Do What It Says', 'Clear Log', 'Exit Liri'],
    },
    {
      type: 'input',
      name: 'arg',
...
function spotifyIt(song) {
  ...
  var spotify = new Spotify({
    id: "58260e84ba394684867be6d00a5aa994",
    secret: "990a58f70143438fb7d63e7281754b63"
  });
  spotify
    .search({
      type: 'track',
...
function movieThis(title) {
  ...
  var queryUrl = "http://www.omdbapi.com/?t=" + title + "&y=&plot=short&apikey=a86db76";
